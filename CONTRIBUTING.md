...
Thanks for your interest in contributing to Codec! We welcome pull requests, issues, and feedback from the community.
...
- Integration tests using `ApplicationContextRunner` for auto-configuration behavior
...
- `feat: add support for new serialization backend`
- `fix: handle edge case in TypeRef equality`
