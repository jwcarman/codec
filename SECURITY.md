...
We aim to support the latest stable release of Codec and provide critical security patches as needed.
...
If you discover a security vulnerability in Codec, please report it responsibly:

**Please DO NOT report security vulnerabilities through public GitHub issues, pull requests, or discussions.**

Instead, please report via:
- **GitHub Security Advisories**: https://github.com/jwcarman/codec/security/advisories/new (preferred)
