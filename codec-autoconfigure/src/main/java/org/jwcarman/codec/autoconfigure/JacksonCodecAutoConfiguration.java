...
/**
 * Auto-configures a {@link JacksonCodecFactory} when the Jackson 3.x backend is on the classpath
 * and no other {@link CodecFactory} bean exists. Highest-precedence backend.
 */
@AutoConfiguration
