...
class ProtobufCodecAutoConfigurationTest {

  private final ApplicationContextRunner contextRunner =
      new ApplicationContextRunner()
          .withConfiguration(AutoConfigurations.of(ProtobufCodecAutoConfiguration.class));

  @Test
  void shouldRegisterProtobufCodecFactoryWhenProtobufIsOnClasspath() {
    contextRunner.run(
        context -> {
